...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name){
        this.name = name;
        setBounds(25, 15, 1250,650);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        
        JLabel jLabel1 = new JLabel();
        jLabel1.setIcon(new ImageIcon(getClass().getResource("/images/quiz_img.jpg")));
        jLabel1.setBounds(0, 10, 1250, 320);
        add(jLabel1);
        
        qno = new JLabel("");
        qno.setBounds(100, 350, 50, 30);
        qno.setFont(new Font("Times New Roman", Font.PLAIN, 23));
        add(qno);
        ...
        next.setBounds(900, 400, 150, 32);
        next.setFont(new Font("Comic Sans MS", 1, 14));
        ...
        lifeline.setBounds(900, 460, 150, 32);
        lifeline.setFont(new Font("Comic Sans MS", 1, 14));
        lifeline.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        lifeline.setHorizontalTextPosition(SwingConstants.CENTER);
        ...
        submit.setBounds(900, 520, 150, 32);
